...
species_of_interest = "/home/calle/Storage/viral_names_2.txt"
try :
    #with open(sys.argv[1],"r") as name_list :
    with open(species_of_interest, "r") as name_list:
            ...
            for name in name_list :
                ...
                for genome in genomes_list :
                    if name == genome[7] :
                        ...
                        file_name = strain_name+"_genomic.faa.gz"
                        link = genome[-1]
                        break
                cmd = "wget "+link+"/*.faa.gz &> /dev/null"
