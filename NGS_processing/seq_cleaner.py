...
The given script cleans multi fasta files by removing sequences to short
and featury to many ambiguous nucleotides.
Call the script and use the following arguments:
(1) input fasta file
(2) minimun sequence length
(3) maximum percentage of ambiguous nucleotides (Ns)

Example: rough_seq_cleaner("path/to/.fasta",min length,allowed percentage of Ns)
"""
