...
fasta_to_be_queried = "/home/calle/Desktop/Svetlana_454_QIIME/TOP50_pmoA_OTUs/fastas/TOP50_otus_shared_mb661r_tax.fasta"
list_of_queries = "/home/calle/Desktop/Svetlana_454_QIIME/TOP50_pmoA_OTUs/TOP50_otus_lists/TOP50_shared.txt"
picked_sequences = "/home/calle/Desktop/Svetlana_454_QIIME/TOP50_pmoA_OTUs/fastas/TOP50_otus_shared_mb661r_single.fasta"

wanted = set(line.rstrip("\n").split(None,1)[0] for line in open(list_of_queries))
print "Found %i unique identifiers in %s" % (len(wanted), list_of_queries)

index = SeqIO.index(fasta_to_be_queried, "fasta")
records = (index[r] for r in wanted)
count = SeqIO.write(records, picked_sequences, "fasta")
